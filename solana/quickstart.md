---
description: >-
  Install the SDK, wire up a Solana wallet provider, and execute your first
  cross-network swap from Solana.
icon: rocket
---
...
Building in React? [`@sodax/wallet-sdk-react`](wallets.md) discovers and connects wallets for you and hands back a ready-made provider via `useWalletProvider`.
