...
* **Your fee**: optional platform fee on top, set by you and paid to you — the only fee you control. Configure it at SDK setup and check it with `getPartnerFee(inputAmount)`. See [Monetize SDK](../developers/packages/sdk/docs/MONETIZE_SDK.md).
