---
description: >-
  Intent-based cross-network swaps from a Solana perspective: one signed
  transaction, solver-filled, settled across networks.
icon: rotate
---
...
* **Reach**: any solver-compatible asset on any SODAX network is a valid destination, 137 assets as of July 2026. The [on-Solana asset list](networks-and-assets.md) only bounds what users hold on Solana itself, not what they can swap into.
