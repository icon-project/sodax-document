...
Using SODAX is free. Trades carry a fixed 0.1% base fee taken by the protocol, and you set your own platform fee on top. That part is fully yours, both the rate and the revenue. See [Monetize SDK](/developers/how-to/monetize-sdk).
...
| --- | --- | --- |
| [`@sodax/sdk`](/developers/packages/foundation/sdk/README) | Full control from any TypeScript backend or frontend | [Quickstart](/solana/quickstart) |
