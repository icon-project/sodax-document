...
- **Your fee**: optional platform fee on top, set by you and paid to you. It is the only fee you control. Configure it at SDK setup and check it with `getPartnerFee(inputAmount)`. See [Monetize SDK](/developers/how-to/monetize-sdk).
...
Full reference, including raw mode, limit orders, cancellation, and the complete error-code table: [Swaps (Solver)](/developers/packages/foundation/sdk/functional-modules/swaps).
