...
Refer to [Initialising Spoke Provider](https://docs.sodax.com/developers/packages/sdk/docs/HOW_TO_CREATE_A_SPOKE_PROVIDER) section to see how IconSpokeProvider and SonicSpokeProvider can be created.
