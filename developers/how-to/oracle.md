---
description: Unauthenticated candle (OHLC) and live USD mark endpoints for charts, display, and solver-aligned prices — via HTTP or @sodax/sdk.
---
...
Quotes for swaps should go through the [Swaps API](https://docs.sodax.com/developers/packages/foundation/swaps-api) or the SDK. The solver oracle is for display, sanity checks, and tooling — not a substitute for a firm quote.
