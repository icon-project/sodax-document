---
title: "Sponsored Stellar account activation"
sidebarTitle: "Stellar sponsoring (quick)"
description: >-
...
**Examples**
- [apps/demo/src/providers.tsx:49-55](https://github.com/icon-project/sodax-sdks/blob/main/apps/demo/src/providers.tsx#L49-L55) — sponsoring API URL + key setup: reads `VITE_SPONSORING_API_BASE_URL` / `VITE_SPONSORING_API_KEY`, omits each when unset (falls back to the packaged endpoint), passed as `api.sponsoringApiConfig` on the `Sodax` config at [L147](https://github.com/icon-project/sodax-sdks/blob/main/apps/demo/src/providers.tsx#L147). Env placeholders in [apps/demo/example.env](https://github.com/icon-project/sodax-sdks/blob/main/apps/demo/example.env).
