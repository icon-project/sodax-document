...
description: >-
  ...
  Sodax protocol, enabling cross-chain swaps and money market operations.
---
...
#### Swaps (Solver / Intents) [📖](https://github.com/icon-project/sodax-frontend/blob/main/packages/sdk/docs/SOLVER.md)
...
#### Lend and Borrow (Money Market) [📖](https://github.com/icon-project/sodax-frontend/blob/main/packages/sdk/docs/MONEY_MARKET.md)
...
#### Cross-chain bridging (Bridge) [📖](https://github.com/icon-project/sodax-frontend/blob/main/packages/sdk/docs/BRIDGE.md)
...
[Cross-chain bridging docs.](https://github.com/icon-project/sodax-frontend/blob/main/packages/sdk/docs/BRIDGE.md)
...
You can find endpoints [here](../../deployments/relayer-api-endpoints.md).

### Relayer API Endpoints

You can find endpoints [here](../../deployments/solver-api-endpoints.md).
...
Sodax SDK abstracts the heavy lifting of using the relay, but you can find documentation for Intent Relay API in INTENT\_RELAY\_API.md in case you want to explore it.
