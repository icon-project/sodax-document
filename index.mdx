...
<div className="sodax-home-hero">
  <img
    src="/.gitbook/assets/sodax-sdk-2.jpg"
    alt=""
    width="1600"
    height="600"
    className="sodax-home-hero-img"
  />
  <div className="sodax-home-hero-overlay">
    <p className="sodax-home-hero-kicker">SODAX Docs</p>
    <p className="sodax-home-hero-sub">What can we help you build?</p>
    <button type="button" className="sodax-home-hero-search" onClick={openSearch}>
      <span className="sodax-home-hero-search-icon" aria-hidden="true" />
      Search docs…
    </button>
  </div>
</div>
...
<div className="sodax-stat-strip">
  ...
  <div className="sodax-stat-chip"><span id="sodax-stat-assets">30+</span> lending assets</div>
...
<Note>
**Building with an AI agent?** Add the [Builders MCP](https://builders.sodax.com/) (`https://builders.sodax.com/mcp`) for live chains, tokens, quotes, and SDK docs while you integrate.
</Note>
...
<div className="sodax-how-strip">
  <div className="sodax-how-step">
    <span className="sodax-how-num">01 · Submit</span>
    <strong>Quote and submit an intent</strong>
    <p>Declare the outcome — not the hop-by-hop route.</p>
  </div>
  <div className="sodax-how-step">
    <span className="sodax-how-num">02 · Fill</span>
    <strong>Solvers fill it</strong>
    <p>Independent solvers fill across networks from coordinated liquidity.</p>
  </div>
  <div className="sodax-how-step">
    <span className="sodax-how-num">03 · Settle</span>
    <strong>Status is explicit</strong>
    <p>Poll until solved or failed — terminal states, not a silent partial fill.</p>
  </div>
</div>
...
<CardGroup cols={2}>
  <Card title="5-minute swap" icon="bolt" href="/quickstart">
